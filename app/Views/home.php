        ...
        <div class="card-body">
            <div class="col-md-12 col-sm-12 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">2003</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">1001</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Jumlah Siswi</span>
                        <span class="info-box-number">1002</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
