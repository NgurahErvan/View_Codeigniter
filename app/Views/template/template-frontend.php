...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= base_url('/') ?>" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light"><b>PPDB Bali</b></span>
                </a>
        ...
        <footer class="main-footer">
            <!-- To the right -->
            <!-- Default to the left -->
            <strong>I Gusti Ngurah Ervan Juli Ardana - 5025211205</a> - </strong> Pemrograman Berbasis Kerangka Kerja (A)
        </footer>
    </div>
    <!-- ./wrapper -->
